...
class ApiClient:
    ...
    def authenticate(self, email: str, password: str):
        ...
        r = self.session.post(self.base_url + "/connexion", data=data, follow_redirects=True)
        r.raise_for_status()
    ...
    def get_lists(self) -> List[WishList]:
        ...
        r = self.session.get(self.base_url + "/module/mywishlist/action", params=params, headers=self.json_headers)
        r.raise_for_status()
    ...
    def create_list(self, name:str ) -> WishList:
        ...
        r = self.session.post(self.base_url + "/module/mywishlist/action", params=params, headers=self.json_headers)
        r.raise_for_status()
        res = r.json()
        assert res["success"]
    ...
    def get_products_in_list(self, list: WishList) -> List[Product]:
        ...
        r = self.session.get(self.base_url + "/module/mywishlist/view", headers=self.json_headers, params=params)
        r.raise_for_status()
...
def main():
    ...
    new_list = client.create_list("merged")
